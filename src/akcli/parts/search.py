...
Everything else in ``akcli`` is strictly offline. This module talks to
...
(``jlcparts`` data). It is import-isolated under ``akcli.parts`` and is
...
USER_AGENT = (
    f"akcli/{__version__} "
    "(+https://github.com/tipoLi5890/akcli; jlcsearch client)"
)
