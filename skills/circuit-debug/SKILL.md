...
- Cross-sheet note: geometry never connects across sheets; only power ports, global labels,
  ports/sheet entries merge by name. A "split" between sheets with only local labels is expected.
